...
wget -q --show-progress https://github.com/rern/OSMC/blob/master/OSMC_GPIO/uninstall.sh
wget -q --show-progress https://github.com/rern/OSMC/blob/master/OSMC_GPIO/_repo/OSMC_GPIO.tar.xz
